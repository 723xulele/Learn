...
public class DateUtil {
     ...
     * DATETIME_FORMAT_8
     */
    public static final String DATETIME_FORMAT_8 = "yyyyMMddHH";
     ...
     * TIME_FORMAT_3
     */
    public static final String TIME_FORMAT_3 = "HH";

    /**
     * TIME_FORMAT_4
     */
    public static final String TIME_FORMAT_4 = "mm";
    ...
    public static Date string2Date(String date, String format) {
        if (StringUtils.isEmpty(format)) {
            throw new IllegalArgumentException("the date_ymd format string is null!");
        }
        SimpleDateFormat sdf = getDateFormat(format);
        try {
            return sdf.parse(date);
        } catch (ParseException e) {
            throw new IllegalArgumentException("the date_ymd string " + date + " is not matching format: " + format, e);
        }
    }
    ...
    public static boolean isInRange(String date, String beginDate, String endDate) {
        ...
        if (!Objects.equal(beginDateLen, dateLen) || !Objects.equal(dateLen, endDateLen)) {
            throw new RuntimeException("日期长度不一致！");
        }
     ...
     * @return
     */
    public static String getWeekFirstDayToString(Date time) {
     ...
     * @return
     */
    public static String getWeekEndDayToString(Date time) {
     ...
     * @return
     */
    public static String getLastHourStartStr() {
        Date date = DateUtil.offsetHour(new Date(), -1);
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(Calendar.MINUTE, 0);
        cal.set(Calendar.SECOND, 0);
        ...
        return DateUtil.getDate(time, DateUtil.DATETIME_FORMAT_1);
    }
     ...
     * @return
     */
    public static String getLastHourEndStr() {
        Date date = DateUtil.offsetHour(new Date(), -1);
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(Calendar.MINUTE, 59);
     ...
     * @return
     */
    public static String getHourStartStr(Date date) {
     ...
     * @return
     */
    public static String getHourEndStr(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        cal.set(Calendar.MINUTE, 59);
        cal.set(Calendar.SECOND, 59);
    ...
    /**
     * 获取两个时间内所有日期 yyyy-MM-dd
     *
     * @param start
     * @param end
     * @return
     */
    public static List<String> queryDates(String start, String end) {
     ...
     * @return
     */
    public static Date timeStampParseToDate(Long timeStamp) {
